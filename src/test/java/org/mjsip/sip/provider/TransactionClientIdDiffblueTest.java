...
class TransactionClientIdDiffblueTest {
  @Test
  void testConstructor() {
    // Arrange, Act and Assert
    assertEquals("Method", (new TransactionClientId("Method")).toString());
    assertEquals("Call id-1-Method-client-janedoe/featurebranch",
        (new TransactionClientId("Call id", 1L, "Method", "Sent by", "janedoe/featurebranch")).toString());
    assertEquals("Call id-1-INVITE-client-janedoe/featurebranch",
        (new TransactionClientId("Call id", 1L, "ACK", "Sent by", "janedoe/featurebranch")).toString());
    assertEquals("Method", (new TransactionClientId(new TransactionClientId("Method"))).toString());
  }
  ...
  void testConstructor2() {
    ...
    // Act and Assert
    assertEquals("42-42--client-null", (new TransactionClientId(sipMessage)).toString());
  ...
  void testConstructor3() {
    ...
    // Act and Assert
    assertEquals("42-1-Method-client-null", (new TransactionClientId(sipMessage)).toString());
    verify(sipMessage).getCSeqHeader();
    verify(sipMessage).getCallIdHeader();
    verify(sipMessage).getViaHeader();
  }
  ...
  void testConstructor5() {
    ...
    // Act and Assert
    assertEquals("42-1-Method-client-janedoe/featurebranch", (new TransactionClientId(sipMessage)).toString());
    verify(sipMessage).getCSeqHeader();
    verify(sipMessage).getCallIdHeader();
    verify(sipMessage).getViaHeader();
    verify(cSeqHeader).getMethod();
